    ...
    def _create_estimator_inputs(
        ...
        estimator_inputs = {
            estimator_name: {
                ...
                for input_ in ["reward", "context", "action", "position", "pscore"]
            }
        ...
        for estimator_name in self.ope_estimators_:
            ...
            estimator_inputs[estimator_name]["behavior_action_dist"] = behavior_action_dist
            if isinstance(estimated_rewards_by_reg_model, dict):
                ...
                elif 'common' in estimated_rewards_by_reg_model:
                    estimator_inputs[estimator_name][
                        "estimated_rewards_by_reg_model"
                    ] = estimated_rewards_by_reg_model['common']
                else:
                    estimator_inputs[estimator_name][
                        "estimated_rewards_by_reg_model"
                    ] = None
    ...
    def evaluate_performance_of_estimators(
        ...
        for estimator_name, estimator in self.ope_estimators_.items():
            ...
            if metric == "relative-ee":
                ...
                eval_metric_ope_dict[estimator_name] = min(se_, 1.0)
